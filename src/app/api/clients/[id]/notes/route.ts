...
const body = await request.json()
    ...
    // Create note record
    const noteId =  
const newNote = {,      id: noteId,      clientId,      content: content.trim(),      author: 'Current User', // In a real app, get from session,      createdAt: new Date().toISOString()
    ...
    // Create timeline entry for the note,    const timelineEntry = {,      id: `timeline_${Date.now()}`,      type: 'note',      title: 'Nota adicionada',      description: content.trim(),      timestamp: new Date().toISOString(),      author: 'Current User',      metadata: {
        noteId: noteId
      }
    },
