...
const averageTicket = 2500
    ...
    // Client stats,    const clientsThisWeek = await prisma.client.count({,      where: { ,        createdAt: { 
...
const conversionRate = totalClients > 0 ? ,      Math.round((convertedClients / totalClients) * 100) : 0
    ...
    // Clients by status,    const clientsByStatus = await prisma.client.groupBy({,      by: ['status']
      _count: { status: true }
    }),
    ...
    // Consultations by type (mock data),    const consultationsByType = [,      { type: 'Inicial', count: 45, revenue: 22500 },      { type: 'Revisão', count: 23, revenue: 11500 },      { type: 'Urgente', count: 12, revenue: 18000 },      { type: 'Especializada', count: 8
 revenue: 12000 }
    ]
    ...
    // Top performers (mock data),    const topPerformers = [,      { consultant: 'Ana Silva', clientsHandled: 23, revenue: 57500, satisfaction: 4.8 },      { consultant: 'Carlos Santos', clientsHandled: 19, revenue: 47500, satisfaction: 4.6 },      { consultant: 'Lucia Costa', clientsHandled: 17, revenue: 42500
 satisfaction: 4.7 }
    ]
    ...
    // Communication stats (mock data),    const communicationStats = {,      whatsappToday: 45,      emailsToday: 23,      callsToday: 12,      responseTime: 2.3,      pendingMessages: 8
      unreadMessages: 15
    },
