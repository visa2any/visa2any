...
export async function GET(request: NextRequest) {,  try {,    return NextResponse.json({,      message: 'WhatsApp API está funcionando!',      timestamp: new Date().toISOString(),      info: {,        integrated: true,        backend: 'Next.js'
