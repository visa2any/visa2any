...
export async function GET(request: NextRequest) {,  try {,    const { searchParams } = new URL(request.url),    const period = searchParams.get('period') || '30' // dias,    const periodDays = parseInt(period),    
