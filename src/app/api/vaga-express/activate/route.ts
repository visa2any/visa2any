...
const webhookSecret = headers.get('x-webhook-secret'),    
    ...
    console.log('💾 Salvando Vaga Express no banco:', {      purchaseId,      plan,      clientName,      amount,      status: 'ACTIVE'
    })
