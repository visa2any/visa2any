...
const webhookSecret = headers.get('x-webhook-secret'),    
 ...
 apenas logar
    ...
    // Salvar no banco de dados local (simulado),    console.log('💾 Salvando Vaga Express no banco:', {,      purchaseId,      plan,      clientName,      amount
      status: 'ACTIVE'
    })
