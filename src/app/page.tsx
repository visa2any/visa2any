...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      {/* Widget flutuante removido para manter design limpo */}

      {/* Footer Premium - CONVERSÃO E AUTORIDADE */}
          ...
          <div className="grid lg:grid-cols-5 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-300">
                ...
                <li><a href="/servicos/vistos" className="hover:text-white transition-colors hover:underline">📄 Vistos</a></li>
                <li><a href="/servicos/imigracao" className="hover:text-white transition-colors hover:underline">🌍 Imigração</a></li>
              </ul>
            </div>
            
            {/* Países */}
            <div>
              <h3 className="text-lg font-semibold mb-6 text-purple-400">🌍 Países</h3>
              <ul className="space-y-3 text-gray-300">
                <li><a href="/paises/eua" className="hover:text-white transition-colors hover:underline">🇺🇸 Estados Unidos</a></li>
                <li><a href="/paises/canada" className="hover:text-white transition-colors hover:underline">🇨🇦 Canadá</a></li>
                <li><a href="/paises/portugal" className="hover:text-white transition-colors hover:underline">🇵🇹 Portugal</a></li>
                <li><a href="/paises/australia" className="hover:text-white transition-colors hover:underline">🇦🇺 Austrália</a></li>
                <li><a href="/precos" className="hover:text-white transition-colors hover:underline text-blue-300">Ver todos 50+ países →</a></li>
              </ul>
            </div>
            
            {/* Contato */}
            <div>
              <h3 className="text-lg font-semibold mb-6 text-green-400">📞 Contato</h3>
              <ul className="space-y-4 text-gray-300">
                ...
                <li>
                  <a href="mailto:contato@visa2any.com" className="flex items-center gap-2 hover:text-blue-400 transition-colors group">
                    <span className="text-sm">📧</span>
                    <span>contato@visa2any.com</span>
                  </a>
                </li>
